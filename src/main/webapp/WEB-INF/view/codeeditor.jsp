...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid" style="height: 100%;position:relative;">
            <div style=" position:absolute; width: 100%; height : 70vh; bottom: 0px; padding: 0px;">
                <div id="monokai" style="height: 100%; width: 100%; padding: 0px; border: 4px #0b2e13"></div>
            </div>
            ...
            <script>
                ...
                var editor = CodeMirror(document.querySelector('#monokai'), codeObj);
